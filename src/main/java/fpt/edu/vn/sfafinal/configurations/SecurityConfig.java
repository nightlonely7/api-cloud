...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/products", "/categories", "/suppliers", "/payments").permitAll()
                .antMatchers(HttpMethod.GET, "/image").permitAll()
                .antMatchers(HttpMethod.POST, "/payments").permitAll()
                .antMatchers(HttpMethod.POST, "/products", "/categories", "/suppliers", "/image").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/products", "/categories", "/suppliers").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/products", "/categories", "/suppliers").hasRole("ADMIN")
